...
const ShareModel = ({ roomId, collaborators, creatorId, currentUserType }: ShareDocumentDialogProps) => {
    ...
    const shareDocumentHanndler = async () => {
        setLoading(true);
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            ...
            <DialogContent className="shad-dialog">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <Button type="submit" onClick={shareDocumentHanndler}
                        className="gradient-blue flex h-full gap-1 px-5" disabled={loading}>{loading ? 'Sending...' : 'Invite'}
                ...
                <div className="my-2 space-y-2">
                    <ul className="flex flex-col">
                        {collaborators.map((collaborator) => (
                            <Collaborator key={collaborator.id} roomId={roomId} creatorId={creatorId}
